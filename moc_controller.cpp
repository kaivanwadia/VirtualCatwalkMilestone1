...
**
** Created: Sun Nov 23 16:06:56 2014
...
static const char qt_meta_stringdata_Controller[] = {
    ...
    "vx,vy,vz,wx,wy,wz\0"
    "accelerateBody(double,double,double,double,double,double)\0"
    "simTick()\0"
};
...
void Controller::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->accelerateBody((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])),(*reinterpret_cast< double(*)>(_a[4])),(*reinterpret_cast< double(*)>(_a[5])),(*reinterpret_cast< double(*)>(_a[6]))); break;
