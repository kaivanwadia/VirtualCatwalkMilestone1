...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Nov 19 17:10:31 2014
# Project:  catwalk.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/catwalk1.0.0/ && $(COPY_FILE) --parents mainwindow.h glpanel.h controller.h simulation.h simparameters.h mesh.h rigidbodytemplate.h rigidbodyinstance.h vectormath.h camera.h rotator.h signeddistancefield.h collisions/Distance.h collisions/CTCD.h .tmp/catwalk1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp glpanel.cpp controller.cpp simulation.cpp simparameters.cpp mesh.cpp rigidbodytemplate.cpp rigidbodyinstance.cpp vectormath.cpp camera.cpp rotator.cpp signeddistancefield.cpp collisions/CTCD.cpp .tmp/catwalk1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/catwalk1.0.0/ && (cd `dirname .tmp/catwalk1.0.0` && $(TAR) catwalk1.0.0.tar catwalk1.0.0 && $(COMPRESS) catwalk1.0.0.tar) && $(MOVE) `dirname .tmp/catwalk1.0.0`/catwalk1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/catwalk1.0.0
